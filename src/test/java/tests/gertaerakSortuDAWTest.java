...
public class gertaerakSortuDAWTest {
	...
	public void test1() {
		...
		boolean result = dt.gertaerakSortu(description, data, sport);
	...
	public void test2() {
		...
		dt.gertaerakSortu(description, data, sport);	// crear el evento con anterioridad, para que despues el sistema detecte que ya exite un evento con esa descripcion, y de esta forma conseguir que el if de dentro del foreach sea true
		boolean result = dt.gertaerakSortu(description, data, sport);
	...
	public void test5() {
		...
		dt.gertaerakSortu(description, data, sport);
		description = "Atletico-Levante";
		boolean result = dt.gertaerakSortu(description, data, sport);
