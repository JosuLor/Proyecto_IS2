...
public class BLFacadeImplementation  implements BLFacade {
	...
	@WebMethod	
	public void diruaSortu(Registered u, Double dirua, String mota) {
		Date data = new Date();
		dbManager.open(false); 
	...
	/**
	 * Se realiza una llamada a la base de datos y se copia un evento existente en una fecha dada
