...
public class DataAccess  {
	...
	public void initializeDB(){
		...
		try {
			...
			String transMessage = "ApustuaEgin";
			...
			Transaction t5 = new Transaction(reg4, apA3.getBalioa(), new Date(), transMessage);
			Transaction t6 = new Transaction(reg4, apA6.getBalioa(), new Date(), transMessage);
			Transaction t7 = new Transaction(reg1, apA7.getBalioa(), new Date(), transMessage);
			Transaction t8 = new Transaction(reg1, apA8.getBalioa(), new Date(), transMessage);
			Transaction t9 = new Transaction(reg2, apA9.getBalioa(), new Date(), transMessage);
			Transaction t10 = new Transaction(reg2, apA10.getBalioa(), new Date(), transMessage);
			Transaction t11 = new Transaction(reg3, apA11.getBalioa(), new Date(), transMessage);
			Transaction t12 = new Transaction(reg3, apA12.getBalioa(), new Date(), transMessage);
